...
\begin{frame}
  ...
  \includegraphics[width=1in]{sushi_salmon}\makebox[2.5in]{salmon is
    better than anago}\includegraphics[width=1in]{sushi_anago}

\includegraphics[width=1in]{sushi_chu-toro}\makebox[2.5in]{\alert<2>{chu-toro is
  as good as kani-miso}}\includegraphics[width=1in]{sushi_kani-miso}
...
\begin{frame}
  ...
  \input{figure-max-margin-bothsides-lines}
  \vskip -2.2cm
  \begin{equation*}
  \begin{aligned}
...
\begin{frame}
  ...
  \input{figure-max-margin-oneside-lines}
  \vskip -2.2cm
  \begin{equation*}
  \begin{aligned}
    \maximize_{\mu\in\RR, \mathbf w\in\RR^p}\ & \mu \\
